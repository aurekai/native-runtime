...
/*
 * akai-leapfrog — Hamiltonian conservation and reversibility test
 *
 ...
 *
 * Uses the pack/BVH produced by akai-violence (or builds them fresh).
 */
...
#define PACK_PATH     "/tmp/akai-violence.bfpk"
#define BVH_PATH      "/tmp/akai-violence.bfvh"
