...
/*
 * akai-capability - capability discovery and matching layer.
 *
 ...
 *
 * Commands:
 *   akai-capability status              - registry summary
 *   akai-capability list                - all capabilities
 *   akai-capability search <query>      - full-text capability search
 *   akai-capability show <cap-id>       - full capability record
 *   akai-capability match <description> - semantic match for a task
 *   akai-capability index               - rebuild full-text index
 *   akai-capability help                - this message
 */
...
static const BuiltinCapability BUILTINS[] = {
    {
        ...
        "akai-ingest", "run", "-", "cpu", "instant", "ingest", "artifact",
        0.001,
    ...
    },
    {
        ...
        "akai-mediaprep", "run", "-", "cpu", "fast", "transform", "media-assets",
        0.003,
    ...
    },
    {
        ...
        "akai-transcribe", "run", "whisper-large-v3", "gpu", "batch", "ingest", "transcript",
        0.006,
    ...
    },
    {
        ...
        "akai-clean", "run", "-", "cpu", "fast", "transform", "clean-transcript",
        0.001,
    ...
    },
    {
        ...
        "akai-paragraph", "run", "-", "cpu", "fast", "transform", "paragraphs",
        0.002,
    ...
    },
    {
        ...
        "akai-brief", "run", "llama-3-8b-instruct", "cpu", "fast", "transform", "brief",
        0.002,
    ...
    },
    {
        ...
        "akai-proof", "run", "-", "cpu", "fast", "score", "proof",
        0.003,
    ...
    },
    {
        ...
        "akai-offer", "run", "-", "cpu", "fast", "transform", "offer",
        0.002,
    ...
    },
    {
        ...
        "akai-narrate", "run", "-", "cpu", "batch", "emit", "narration",
        0.004,
    ...
    },
    {
        ...
        "akai-pack", "run", "-", "cpu", "fast", "emit", "bundle",
        0.001,
    ...
    },
    {
        ...
        "akai-distribute", "run", "-", "cpu", "batch", "emit", "distribution",
        0.010,
    ...
    },
    {
        ...
        "akai-embed", "run", "nomic-embed-text", "cpu", "fast", "transform", "embeddings",
        0.003,
    ...
    },
    {
        ...
        "akai-segment", "run", "pyannote-speaker-segmentation", "gpu", "batch", "transform", "segments",
        0.005,
    ...
    },
    {
        ...
        "akai-control", "score", "-", "cpu", "instant", "score", "score",
        0.000,
    ...
    },
    {
        ...
        "akai-queue", "add", "-", "cpu", "instant", "infra", "queue-entry",
        0.000,
    ...
    },
    {
        ...
        "akai-sync", "run", "-", "cpu", "instant", "infra", "sync-manifest",
        0.000,
    ...
    },
    {
        ...
        "akai-model", "route", "-", "cpu", "instant", "registry", "model-ref",
        0.000,
    ...
    },
    {
        ...
        "akai-layer", "list", "-", "cpu", "instant", "registry", "layer-spec",
        0.000,
    ...
    },
    {
        ...
        "akai-sli", "route", "-", "cpu", "fast", "optimization", "routed-family",
        0.000,
    ...
    },
    {
        ...
        "akai-fpq", "run", "-", "cpu", "batch", "optimization", "fpq-pack",
        0.000,
    ...
    },
    {
        ...
        "akai-recipe", "validate", "-", "cpu", "instant", "registry", "recipe-record",
        0.000,
    ...
    },
    {
        ...
        "akai-run", "run", "-", "cpu", "batch", "runtime", "run-manifest",
        0.000,
    ...
    },
    {
        ...
        "akai-capability", "match", "-", "cpu", "instant", "registry", "capability-match",
        0.000,
...
static sqlite3 *open_db(void) {
    ...
    if (bf_ensure_dir(dir) != 0) {
        fprintf(stderr, "akai-capability: failed to create db directory: %s\n", dir);
        exit(1);
    }

    if (bf_sqlite3_open(path, &db) != SQLITE_OK) {
        fprintf(stderr, "akai-capability: db open failed: %s\n", path);
        exit(1);
    }
...
static void cmd_match(sqlite3 *db, const char *desc) {
    ...
    if (ntokens <= 0) {
        fprintf(stderr, "akai-capability: no recognizable words in description\n");
        return;
    }
...
static void cmd_help(void) {
    printf(
"akai-capability %s - capability discovery and matching\n\n"
"USAGE\n"
"  akai-capability <command> [args]\n\n"
"COMMANDS\n"
...
int main(int argc, char **argv) {
    ...
    if (strcmp(cmd, "status") == 0) cmd_status(db);
        ...
        if (argc < 3) {
            fprintf(stderr, "usage: akai-capability search <query>\n");
            rc = 1;
        } else cmd_search(db, argv[2]);
    } else if (strcmp(cmd, "show") == 0) {
        if (argc < 3) {
            fprintf(stderr, "usage: akai-capability show <cap-id>\n");
            rc = 1;
        } else cmd_show(db, argv[2]);
    } else if (strcmp(cmd, "match") == 0) {
        if (argc < 3) {
            fprintf(stderr, "usage: akai-capability match <description>\n");
            rc = 1;
        } else cmd_match(db, argv[2]);
    } else if (strcmp(cmd, "index") == 0) cmd_index(db);
    else {
        fprintf(stderr, "akai-capability: unknown command: %s\n", cmd);
        rc = 1;
    }
