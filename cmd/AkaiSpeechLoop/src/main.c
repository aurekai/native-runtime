 ...
 *
 * Usage:
 *   akai-speechloop transform <input-audio> <out-dir> [--voice-model PATH]
 *                      [--model whisper-model] [--compress] [--brief]
 *   akai-speechloop narrate-brief <brief-dir> <out-dir> [--voice-model PATH]
 *
...
static void print_usage(void) {
    fprintf(stderr,
        "akai-speechloop — whisper → transform → piper speech engine\n\n"
        "Usage:\n"
        "  akai-speechloop transform <input-audio> <out-dir>\n"
        "    [--voice-model PATH] [--model NAME] [--compress] [--brief]\n\n"
        "  akai-speechloop narrate-brief <brief-dir> <out-dir>\n"
        "    [--voice-model PATH]\n\n"
        "The transform loop:\n"
