...
/*
 * akai-flashqla — BonfyreGDN Chunked Prefill (native C kernel).
 *
 ...
 *   akai-flashqla compare-external  --in t.bfgla --out ext.bfgdn
 *   Requires: SM90+, CUDA 12.8+, PyTorch 2.8+, flash_qla package.
 *   Not used in production.
 *
 * Usage:
 *   akai-flashqla run    --in t.bfgla --out o.bfgdn [--backend auto]
 *                           [--chunk-size 64]
 *   akai-flashqla gen    --B 1 --T 128 --H 8 --K 64 --V 64 --out t.bfgla
 *   akai-flashqla verify --ref a.bfgdn --test b.bfgdn
 *   akai-flashqla bench  [--backend auto|ref|tile] [--compare]
 *   akai-flashqla compare-external  --in t.bfgla --out ext.bfgdn
 *   akai-flashqla doctor
 *
 * Environment:
...
static int cmd_doctor(void) {
    printf("akai-flashqla v" VERSION " — doctor\n\n");
...
static void usage(void) {
    fprintf(stderr,
        "akai-flashqla v" VERSION " — BonfyreGDN Chunked Prefill\n\n"
        "Usage:\n"
        "  akai-flashqla run    --in t.bfgla --out o.bfgdn\n"
        "                          [--backend auto|ref|tile|avx2|neon] [--chunk-size 64]\n"
        "  akai-flashqla gen    --B 1 --T 128 --H 8 --K 64 --V 64 --out t.bfgla\n"
        "                          [--seed N]\n"
        "  akai-flashqla verify --ref a.bfgdn --test b.bfgdn\n"
        "  akai-flashqla bench  [--B 1] [--T 256] [--H 8] [--K 64] [--V 64]\n"
...
int main(int argc, char **argv) {
    ...
    if (strcmp(cmd, "--version") == 0 || strcmp(cmd, "version") == 0) {
        printf("akai-flashqla v" VERSION "\n"); return 0;
    }
    ...
    fprintf(stderr, "akai-flashqla: unknown command '%s'\n", cmd);
    usage();
    return 1;
}
