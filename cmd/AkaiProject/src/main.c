...
static void print_usage(void) {
    fprintf(stderr,
            "akai-project\n\n"
            "Usage:\n"
            "  akai-project cms <cms args...>\n"
            "  akai-project index <index args...>\n"
            "  akai-project stitch <stitch args...>\n"
            "  akai-project refresh <artifact-dir> [--db FILE]\n");
}
...
int main(int argc, char **argv) {
    ...
    const char *cms_bin = default_binary("BONFYRE_CMS_BINARY", argv[0], cms_resolved, sizeof(cms_resolved), "BonfyreCMS", "akai-cms", "../BonfyreCMS/akai-cms");
    const char *index_bin = default_binary("BONFYRE_INDEX_BINARY", argv[0], index_resolved, sizeof(index_resolved), "BonfyreIndex", "akai-index", "../BonfyreIndex/akai-index");
