...
BIN="/workspace/bonfyre/10-Code/AkaiFPQ/akai-fpq"
...
echo "═══════════════════════════════════════════════════════"
echo " Akai Weight Algebra — Compound Showcase"
...
echo "  huggingface-cli upload NICKO/Qwen2.5-3B-AkaiAlgebra-FPQ3 $OUT/qwen2.5-3b-algebra-fpq3"
echo "  huggingface-cli upload NICKO/Whisper-Large-V3-AkaiAlgebra-FPQ3 $OUT/whisper-large-v3-algebra-fpq3"
echo "  huggingface-cli upload NICKO/Qwen2.5-3B-Merged-AkaiAlgebra $OUT/qwen2.5-3b-merged-algebra"
echo "  huggingface-cli upload NICKO/Whisper-Large-V3-Pruned-AkaiAlgebra $OUT/whisper-large-v3-pruned-algebra"
