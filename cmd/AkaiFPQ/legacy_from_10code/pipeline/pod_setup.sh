#!/bin/bash
# AkaiFPQ — RunPod Pod Setup Script
# Run this once when a pod starts. Compiles akai-fpq for Linux + OpenBLAS.
set -euo pipefail

echo "============================================"
echo " AkaiFPQ Pod Setup"
...
# 3. Build akai-fpq for Linux
echo "[3/5] Building akai-fpq..."
cd /workspace/bonfyre/10-Code/AkaiFPQ
...
# Verify build
./akai-fpq 2>&1 | head -3 || true
echo "  Binary: $(ls -lh akai-fpq | awk '{print $5}')"
...
git config --global user.name "AkaiFPQ Worker"

echo ""
echo "============================================"
echo " Setup complete!"
echo " Binary: /workspace/bonfyre/10-Code/AkaiFPQ/akai-fpq"
echo ""
echo " Next: bash /workspace/bonfyre/10-Code/AkaiFPQ/pipeline/worker.sh"
echo "============================================"
