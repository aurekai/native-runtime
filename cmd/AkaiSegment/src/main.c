 ...
 *
 * Usage:
 *   akai-segment graph    <whisper-json> <out-dir>  [--silence-gap 2.0]
 *   akai-segment boundaries <whisper-json> <out-dir> [--silence-gap 2.0]
 *   akai-segment rhythm   <whisper-json> <out-dir>
 *
...
static void print_usage(void) {
    fprintf(stderr,
        "akai-segment — idea boundary detection + segment graph\n\n"
        "Usage:\n"
        "  akai-segment graph      <whisper-json> <out-dir> [--silence-gap SEC]\n"
        "  akai-segment boundaries <whisper-json> <out-dir> [--silence-gap SEC]\n"
        "  akai-segment rhythm     <whisper-json> <out-dir>\n"
        "  akai-segment all        <whisper-json> <out-dir> [--silence-gap SEC]\n\n"
