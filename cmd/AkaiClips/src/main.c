 ...
 *
 * Usage:
 *   akai-clips discover  <whisper-json> <out-dir> [--top N] [--min-dur SEC] [--max-dur SEC]
 *   akai-clips timestamps <whisper-json> <out-dir> [--top N]
 *
...
static void print_usage(void) {
    fprintf(stderr,
        "akai-clips — clip discovery engine\n\n"
        "Usage:\n"
        "  akai-clips discover   <whisper-json> <out-dir> [--top N] [--min-dur S] [--max-dur S]\n"
        "  akai-clips timestamps <whisper-json> <out-dir> [--top N] [--min-dur S] [--max-dur S]\n"
        "  akai-clips all        <whisper-json> <out-dir> [--top N] [--min-dur S] [--max-dur S]\n\n"
