...
static void print_usage(void) {
    fprintf(stderr,
            ...
            "\n"
            "Usage:\n"
            "  akai-media-prep inspect <input>\n"
            "  akai-media-prep normalize <input> <output> [--sample-rate N] [--channels N] [--trim-silence] [--loudnorm]\n"
            "  akai-media-prep denoise <input> <output>\n"
            "  akai-media-prep chunk <input> <output-pattern> [--segment-seconds N]\n"
            "  akai-media-prep split-speech <input> <output-pattern> [--noise-threshold DB] [--min-silence SEC] [--min-speech SEC] [--padding SEC]\n");
}
