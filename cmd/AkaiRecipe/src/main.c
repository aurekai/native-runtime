...
static int cmd_init(const char *db_path) {
    ...
    printf("\nNext steps:\n");
    printf("  akai-recipe add <recipe.json>\n");
    printf("  akai-recipe list\n");
...
int main(int argc, char **argv) {
    ...
    if (strcmp(cmd, "init") == 0) {
        ...
        if (argc < 3) {
            fprintf(stderr, "Usage: akai-recipe show <RECIPE_ID>\n");
            return 1;
        }
        ...
        if (argc < 3) {
            fprintf(stderr, "Usage: akai-recipe add <RECIPE.json>\n");
            return 1;
        }
        ...
        if (argc < 3) {
            fprintf(stderr, "Usage: akai-recipe search <QUERY>\n");
            return 1;
        }
        ...
        if (argc < 3) {
            fprintf(stderr, "Usage: akai-recipe validate <RECIPE.json>\n");
            return 1;
        }
        ...
        if (argc < 3) {
            fprintf(stderr, "Usage: akai-recipe hash <RECIPE.json>\n");
            return 1;
        }
