 ...
 *
 * Usage:
 *   akai-ledger assess <artifact.json>         — value a single family
 *   akai-ledger portfolio <root_dir>            — roll up everything
 *   akai-ledger delta <artifact.json> [--since DATE]  — value added since date
 *   akai-ledger export <root_dir> [--format json|csv] — full export
 */
#include <errno.h>
#include <limits.h>
#include <stdio.h>
...
int main(int argc, char *argv[]) {
    ...
    fprintf(stderr,
        "BonfyreLedger — value accounting engine\n\n"
        "  akai-ledger assess <artifact.json>          detailed family report\n"
        "  akai-ledger assess-json <artifact.json>     JSON output\n"
        "  akai-ledger portfolio <root_dir>             full portfolio roll-up\n"
        "  akai-ledger delta <artifact.json>            value changes\n"
        "  akai-ledger export <root_dir> [--format json|csv]\n"
        "  akai-ledger layer <artifact_id> [--root DIR]\n"
    );
    return 1;
}
