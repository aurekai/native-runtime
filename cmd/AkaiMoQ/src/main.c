...
/*
 * akai-moq — Media over QUIC style relay for Bonfyre
 *
 * This implementation provides a practical local relay mode for video frames:
 *
 *   akai-moq video-relay --ingest 9450 --subscribe 9451
 *
...
static void cmd_help(void) {
    printf(
"akai-moq %s — media relay\n\n"
"USAGE\n"
"  akai-moq <command> [args]\n\n"
"COMMANDS\n"
...
int main(int argc, char **argv) {
    ...
    fprintf(stderr, "akai-moq: unknown command '%s'\n", argv[1]);
    fprintf(stderr, "Run 'akai-moq help' for usage.\n");
    return 1;
}
