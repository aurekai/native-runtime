...
usage:
    fprintf(stderr,
            "Usage:\n"
            "  akai-sync inspect-intake <path>\n"
            "  akai-sync inspect-status <path>\n"
            "  akai-sync push <local.json> <remote-url>\n"
            "  akai-sync pull <remote-url> <local.json>\n"
            "  akai-sync layer <artifact_id> [--manifest-only|--include-payload] [--root DIR]\n");
    return 1;
}
