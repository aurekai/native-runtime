...
/*
 * akai-learn — artifact-level feedback and threshold tuning.
 *
 ...
 * akai-compete produces wins/losses; akai-learn converts them to
 * threshold updates and shares them with akai-control.
 *
 * DB: ~/.local/share/bonfyre/learn.db  (override: $BONFYRE_LEARN_DB)
 *
 * Commands:
 *   akai-learn status               — stage thresholds + recent tuning
 *   akai-learn feedback <run-id> <score> [label]   — record outcome
 *   akai-learn tune <stage>         — run threshold update for a stage
 *   akai-learn list                 — all tracked stages
 *   akai-learn export               — dump thresholds as JSON
 *   akai-learn reset <stage>        — restore default thresholds
 *   akai-learn history [stage]      — recent feedback records
 *   akai-learn help                 — this message
 */
...
static void cmd_help(void){
    printf(
"akai-learn %s — artifact feedback and threshold tuning\n\n"
"USAGE\n"
"  akai-learn <command> [args]\n\n"
"COMMANDS\n"
...
"INTEGRATION\n"
"  akai-compete → akai-learn feedback (win/loss signals)\n"
"  akai-control reads exported thresholds for routing gates\n\n"
"ENVIRONMENT\n"
